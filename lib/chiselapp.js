...
chiselApp.factory("chiselChatFactory", function (firebaseFactory, $firebase) {
    var channelFactory = {
        ...
        getChannel : function (channelId) {
            return $firebase(firebaseFactory.get('/channels/'+channelId));
        },
        //Make a new channel
...
chiselApp.controller('chiselCtrl', function($scope, $cookies, chiselChatFactory, ccGuestNames, firebaseFactory) {
    $scope.channel = chiselChatFactory.getChannel('-JSzeecQWJKzPVPmt5i7');
    $scope.messages = firebaseFactory.get('/channels/-JSzeecQWJKzPVPmt5i7/messages');
    ...
    $scope.addMessage = function(e) {
        ...
        $scope.messages.$add({
            ...
            dateStamp : Firebase.ServerValue.TIMESTAMP
        });
    };
